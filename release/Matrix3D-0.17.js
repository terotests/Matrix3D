...
(function () {
  ...
  var Matrix3D_prototype = function Matrix3D_prototype() {
    ...
    (function (_myTrait_) {
       ...
       * @param float t
       */
      _myTrait_.addToBatch = function (t) {
      ...
      /**
       * @param Object someVar  - Variable to test
       */
       ...
       */
      _myTrait_.removeListener = function (fn) {
    ...
    (function (_myTrait_) {
      ...
      /**
       * Calculates angle between two 2D vectors (x,y)
       * @param Object v1  - 2D Vector (x,y)
       * @param Object v2  - 2D Vector (x,y)
       */
      _myTrait_.angle2D = function (v1, v2) {
        ...
        var cp = n1.x * n2.y - n1.y * n2.x; // cross product
        var dp = n1.x * n2.x + n1.y * n2.y; // dot product
      ...
      * @param Object dv  - Object containing information about the drag vector 
      * @param float projectionState  
      */
      _myTrait_.dragTransformation = function (dv, projectionState) {
        var point = {};
       ...
       * @param int t  - Accuracy of decimals used
       */
      _myTrait_.get2DTransform = function (t) {
        var nn = t || 3;
        return "matrix(" + this.m00().toFixed(nn) + ", " + this.m01().toFixed(nn) + ", " + this.m10().toFixed(nn) + ", " + this.m11().toFixed(nn) + ", " + this.m30().toFixed(nn) + ", " + this.m31().toFixed(nn) + ")";
      };

      /**
       * @param int t  - Accuracy of decimals used, default 3
       */
      _myTrait_.get3DTransform = function (t) {
        var nn = t || 3;
        return "matrix3d(" + this.m00().toFixed(nn) + ", " + this.m01().toFixed(nn) + ", " + this.m02().toFixed(nn) + ", " + this.m03().toFixed(nn) + "," + this.m10().toFixed(nn) + ", " + this.m11().toFixed(nn) + ", " + this.m12().toFixed(nn) + ", " + this.m13().toFixed(nn) + "," + this.m20().toFixed(nn) + ", " + this.m21().toFixed(nn) + ", " + this.m22().toFixed(nn) + ", " + this.m23().toFixed(nn) + "," + this.m30().toFixed(nn) + ", " + this.m31().toFixed(nn) + ", " + this.m32().toFixed(nn) + ", " + this.m33().toFixed(nn) + ")";
      };

      /**
       * @param float t
       */
      _myTrait_.getCSSMatrix2D = function (t) {
        var nn = 3;
